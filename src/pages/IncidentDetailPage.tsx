...
const IncidentDetailPage: React.FC = () => {
  ...
  const handleStartClick = async () => {
    if (!window.confirm("¿Desea iniciar el trabajo en esta incidencia?"))
      return;
  ...
  const handleRejectAction = async () => {
    ...
    try {
      setProcessing(true);
      await CuadrillaService.rechazarIncidencia(Number(id), {
  ...
  if (error || !incident) {
    return (
      <Container className="py-5">
        ...
        <UiButton onClick={() => navigate("/cuadrilla/incidencias")}>
          Volver
        </UiButton>
      </Container>
    );
    ...
    <div className="bg-light min-vh-100 py-5">
      <Container>
        <div className="mb-4">
          ...
          >
            <ArrowLeftIcon style={{ width: 16 }} className="me-2" /> Volver al
            listado
          </button>
        </div>
            ...
            {incident.estado === "en_proceso" && (
              <>
                ...
                <UiButton
                  ...
                  className="px-3"
                >
                  <CameraIcon style={{ width: 20 }} className="me-1" /> Subir
                  Fotos
                </UiButton>
                <UiButton
                  variant="success"
                ...
                >
                  <CheckIcon style={{ width: 20 }} className="me-1" /> Finalizar
                  Tarea
                </UiButton>
              </>
            )}
          ...
          <Col lg={8}>
            ...
            >
              ...
              <div className="p-4 bg-light rounded-4 border-0 mb-4">
                ...
                <p className="mb-0 text-dark fs-6" style={{ lineHeight: 1.6 }}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="mb-0 fw-medium text-dark fs-5">
                    {incident.ubicacion || "No especificada"}
                  </p>
                </div>
              </div>
            </UiCard>
                ...
                <div className="d-flex flex-column gap-3">
                  {incident.multimedias.map((media: any) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="d-block text-decoration-none shadow-sm rounded-3 overflow-hidden position-relative"
                    >
      ...
      >
        <div
          className="text-center p-5 bg-white rounded-4 border border-2 border-dashed border-primary mx-auto"
      ...
      >
        <Alert
          variant="info"
          className="d-flex align-items-center p-2 small mb-3 border-0 shadow-sm rounded-3"
        >
          <CheckIcon style={{ width: 18 }} className="me-2" /> Recuerda subir
          las fotos antes de finalizar.
        </Alert>
        <UiField
          as="textarea"
          rows={4}
        ...
        <div className="d-flex justify-content-end gap-2 mt-3">
          <UiButton variant="light" onClick={() => setShowFinalizeModal(false)}>
            Cancelar
          </UiButton>
          <UiButton
            variant="success"
      ...
      >
        ...
        />
        <div className="d-flex justify-content-end gap-2 mt-3">
          <UiButton variant="light" onClick={() => setShowRejectModal(false)}>
            Cancelar
          </UiButton>
          <UiButton
            variant="danger"
